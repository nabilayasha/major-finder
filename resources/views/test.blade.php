...
<body>
    <div class="page">
        ...
        <div>
                    ...
                    <div class="owl-carousel" style="margin-top: -70px">
                        ...
                        <div class="px-2 pt-1">
                            <div class="card d-flex align-items-center flex-column text-center">
                                ...
                                <div>
                                    <h5>Semua jawaban adalah valid!</h5>
                                    <p>
            ...
            <div class="container quesition-section" id="question"></div>
            <div class="container d-flex justify-content-end">
                <button class="btn btn-primary btn-lg px-5">Next</button>
            </div>
        </div>
    </div>
    ...
    <script>
        ...
        const data = [
            {
                hint: "Pilih salah satu sesuai kondisi dirimu",
                questionA: "Berhati-hati, penuh pertimbangan, kaku",
                questionB: "Berhati-hati, penuh pertimbangan, kaku",
            },
            {
                hint: "Pilih salah satu sesuai kondisi dirimu",
                questionA: "Berhati-hati, penuh pertimbangan, kaku",
            ...
            <div class="row gy-4">
              <div class="col-xl-6">
                <label class="card-answer">
                  <p class="mb-0">${item.questionA}</p>
                  <div class="checkbox">
                    <div class="is-checked"></div>
                  </div>
                  <input type="radio" name="answer-${index}" class="d-none" />
                </label>
              </div>
              <div class="col-xl-6">
                <label class="card-answer">
                  <p class="mb-0">${item.questionB}</p>
                  <div class="checkbox">
                    <div class="is-checked"></div>
                  </div>
                  <input type="radio" name="answer-${index}" class="d-none" />
